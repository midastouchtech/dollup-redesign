...
function Home({ user }) {
  ...
  return (
    <Layout>
      ...
      <div className='w-screen md:py-5 md:px-40 flex flex-col justify-center align-center '>
        <h1 className='text-left mt-4 px-6 text-3xl mb-6 font-bold'>
          Book a service
        </h1>
        <div className=' px-10  grid md:grid-cols-1 grid-cols-1 px-6 flex flex-col justify-center items-center section-image '>
              ...
              {vendor.services?.map((service) => {
                return (
                  <div>
                    <div
                      key={service.id}
                      className=' h-82 md:h-80 flex items-center justify-center '
                    >
                      <div class='md:max-w-sm w-24 w-2/3 h-82 md:h-82 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700'>
          ...
          {vendor.services?.length <= 3 && (
            <div className='grid md:grid-cols-3 grid-cols-1 px-6 flex flex-col justify-center items-center section-image '>
              {vendor.services?.map((service) => {
                return (
                  <div>
                    <div
                      key={service.id}
                      className=' h-82 md:h-80 flex items-center justify-start '
                    >
                      <div class='md:max-w-sm w-24 w-2/3 h-82 md:h-82 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700'>
                        <div class='h-1/2 md:h-2/3'>
                          <img
      ...
      <div className='my-10 w-screen md:py-5 md:px-40 flex flex-col justify-center align-center '>
        <div className='  grid md:grid-cols-1 grid-cols-1 px-6 flex flex-col justify-center items-center section-image '>
          <h2 className='text-2xl font-bold text-gray-700 mb-4'>
            Choose an expert
          </h2>
          {vendor.stylists?.length > 3 && (
            <Slider {...settings}>
                    ...
                    >
                      <div class='md:max-w-sm w-24 w-2/3 h-82 md:h-82 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700'>
                        <div class='h-1/2 md:h-2/3'>
                          <img
                            class='rounded-t-lg w-full h-full'
                            src={stylist.avatar || '/images/lp.jpeg'}
                            alt=''
                          />
                        </div>
                        <div class='p-2 h-1/2 md:h-fit flex items-center justify-end flex-col'>
      ...
      <div className='my-10 w-screen md:py-5 md:px-40 flex flex-col justify-center align-center '>
        <div className='  grid md:grid-cols-1 grid-cols-1 px-6 flex flex-col justify-center items-center section-image '>
          ...
          {vendor.products?.length <= 3 && (
            <div className='grid md:grid-cols-3 grid-cols-1 px-6 flex flex-col justify-start items-center section-image '>
              {vendor.products?.map((product) => {
                return (
                  <div>
                    <div
      ...
      <div className='w-screen md:py-5 md:px-40 bg-gray-100 flex flex-col justify-center align-center '>
        <div className='md:py-6 py-1  flex md:flex-row flex-col justify-between w-full'>
          <div className='md:w-2/4 w-full px-2  mb-6 md:mb-1'>
            <Datepicker
              value={date}
              ...
              inputClassName='w-full p-6 ps-10 text-sm text-gray-700 rounded-sm border border-gray-900 bg-white focus:ring-blue-500 focus:border-blue-500 dark:bg-pink-700 dark:border-pink-600 dark:placeholder-pink-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'
            />
          </div>
          <div className='md:w-1/4 w-full mb-6 md:mb-1 flex items-center justify-center px-2'>
            <TimePicker
              onChange={setTime}
              value={time}
              className='w-full p-6 text-sm text-gray-700 rounded-sm border border-gray-900 bg-white focus:ring-blue-500 focus:border-blue-500 dark:bg-pink-700 dark:border-pink-600 dark:placeholder-pink-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'
            />
          </div>
          <div className='md:w-1/4 w-full px-4  mb-6 md:mb-1 rounded-sm bg-pink-600 text-gray-100'>
            <button
              onClick={() => createBooking()}
              className='w-full p-4 m-2 text-xl text-gray-100 rounded-sm  bg-pink-600 focus:ring-blue-500 focus:border-blue-500 dark:bg-pink-700 dark:border-pink-600 dark:placeholder-pink-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'
            >
              Book now
            </button>
          </div>
      ...
      <div className='h-fit bg-gray-100 grid md:grid-cols-1 grid-cols-1 flex flex-col justify-center items-center'>
        <div className='bg-pink-100 rounded rounded-lg" md:mx-40 my-10 px-4 h-fit bg-gray-200 grid md:grid-cols-1 grid-cols-1 flex flex-col justify-center items-center'>
          <div className='bg-pink border border-red px-10 py-10 w-92'>
            ...
            <button className='rounded rounded-full bg-pink-600 text-white py-4 px-4 mt-4'>
              Get The App
            </button>
          </div>
        </div>
