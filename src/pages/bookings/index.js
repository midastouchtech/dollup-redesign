...
export default function Home() {
  ...
  useEffect(() => {
    console.log('bookingId', bookingId, SearchParams.get('b'));
    if (bookingId) {
      console.log('have booking id', bookingId);
          ...
          <div className=' md:px-40 h-fit bg-gray-100 grid md:grid-cols-2 grid-cols-1 flex flex-col justify-center items-center'>
            ...
            <div className='bg-pink px-10 py-10'>
              ...
              <p className='text-base'>
                Absolutely amazing! The salon booking system has revolutionized
                my beauty routine. No more waiting on hold or playing phone tag
                to secure an appointment. With just a few clicks, I can book my
                preferred selectedServices, select my favorite selectedStylist,
                and choose a convenient time slot all from the comfort of my
                home. I love it!"
              </p>
