  ...
  return (
    <>
      ...
      <div
        className={` ${
          isOpen ? '' : 'hidden'
        } items-center justify-between  w-full  md:w-auto md:order-1 absolute z-10 h-full bg-gray-50`}
        id='navbar-sticky'
      >
        <ul className='md:bg-transparent sm:bg-transparent  flex p-4 md:p-0 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700 flex-col'>
          ...
          <li>
            {user && (
              <div className='flex items- justify-center p-10 mt-4 bg-gray-200 w-full space-x-6 rtl:space-x-reverse'>
                <Link
                  href='/dashboard'
                  className=' text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800'
                >
